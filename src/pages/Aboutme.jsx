    ...
    `}
      ...
      <div className="flex-1 p-4">
        ...
        {showSecondParagraph && (
          ...
          <p className="text-2xl mt-4"> Fast forward to 2023, I'm currently working with Owen's Transportation, contracted to FedEx Ground. This role has been more than a job; it's been a lesson in grit and perseverance. It's not only enabled me to finance my education in full at the University of Utah, but I like to think this job has really made me stand out among other young adults as most people around my age don't understand that you have to actively put in the work to succeed.</p>
          ...
          <p className="text-2xl mt-4"> My goal? To design and contribute to projects that deliver meaningful change to communities, bringing positive change into this complex world. With every line of code, I strive to blend creativity and functionality. I am devoted to enhancing the efficiency and inclusivity of the digital landscape, ensuring it's accessible and beneficial to everyone.</p>
          </div>
        )}
{showThirdParagraph && (
